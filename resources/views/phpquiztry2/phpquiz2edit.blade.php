...
<div class="sidenav">
  ...
  <div class="button" id="button1" title="points required 0">
    ...
    <div class="button"  title="points required 1000">
      <x-nav-link class="navdes" :href="route('phpquiztry2.phpquiz2')" :active="request()->routeIs('phpquiztry2.phpquiz2')" >
                ...
                <div class="col-6 mx-auto">
                  <div class="card text-center" style=" background-color: white; border: 1px solid black; margin-top:50px;">
                    <div class="card-header" style="background-color: rgb(238, 109, 109); color: black; border-bottom:1px solid black; margin-bottom: 20px;">
                        <p style="font-size: 30px; font-weight">PHP Problem #2</p>
                        <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>&emsp;&emsp;<a href="https://onecompiler.com/php" style="text-decoration: none; color: black; " class=" h5" target="_blank">&#9998;</a>
                            ...
                            <h3><b><i>
                              Using a variable display your name!
                            </i></b></h3>
                            <div><form id="formm" method="GET" action="/phpquiztry2update/{{Auth::user()->id}}/edit">
                              <div style="margin-left: -55%"><p style="font-family: Courier New">&lt;?php </p></div>
                              <div style="">
                                <p style="font-family: Courier New">$txt = "<input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="trysagot" placeholder="Value"  id="ans3" class="m-2 p-1">";
                              </div>
                              <div style=" ">
                                <p style="font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="A" placeholder="Function" id="ans1" class="m-2 p-1"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="B" placeholder="Variable" id="ans2" class="m-2 p-1">;</p></div>
...
TRIVIA: Variables are like a storage for your data
</div>
                  ...
                  <div class="popup" id="popup-1">
                    ...
                    <div style="margin-top:5%; margin-left:8%;"class="content">
                      ...
                      {!! Form::open(['action'=>['App\Http\Controllers\QuizScore\phpquiztry2update@update',$users->id],'method'=>'POST','class'=>'pull-right']) !!}
                            {{Form::hidden('phpscore','2000',['id'=>'1'])}}
