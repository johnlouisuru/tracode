...
<div id="mySidenav" class="sidenav2" style="margin-left: 215px;">
  ...
  <a href="/cuserinput">Inheritance</a>
  <a href="/cnumberinput">Variable</a>
...
<center><h4 style="margin-top: 30px; ">You are now in the intermediate category where you will learn more advanced codes than the previous category<br>
     that you have been encountered good luck learning in this part TraCoder!</h4></center>
