...
<textarea id="source" style="width: calc(53% - 8px)" class ="lined" cols="50" rows="15" placeholder="Enter Syntax Code Here" spellcheck="false" >public class Main {
...
$(function() {
    ...
    <div class="popup" id="popup-1">
      ...
      <div style="margin-top:5%; margin-right:6%;"class="content">
        ...
        {!! Form::open(['action'=>['App\Http\Controllers\JavaScoringController@store'],'method'=>'POST','class'=>'pull-right']) !!}
