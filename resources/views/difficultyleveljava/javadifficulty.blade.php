<x-app-layout>
    <x-slot name="header">
      ...
      <div class="float-right">
       Java Knowledge points: {{Auth::user()->javascore}}
          </div>
    </nav>
    </x-slot>
    ...
    <input id="score"hidden>
    <input id="reqinterscore" value="{{$javaquizreq->Intermediate}}"hidden>
    <input id="reqadvascore" value="{{$javaquizreq->Advance}}"hidden>
    <div class="flex-container">
      ...
      <div class="flex-child 2">
          <p style="text-align: center; margin-right: 9%; margin-left: -2%; font-size: 25px; color: white; font-weight: bold; background-color: #1f2937; border-radius: 10px; border: 1px solid black">Intermediate Level</p><br><p style="text-align: center; margin-right: 10%; font-weight: bold;">Required points to access this level:</p><div style="display: flex; margin-left: 35%; "><p id="interscr" style="font-weight: bold;"></p><p style="font-weight: bold;">&nbsp;points</p></div>
      </div>
      <div class="flex-child 3">
        <p style="text-align: center; margin-right: 6%; margin-left: 0%; font-size: 25px; color: white; font-weight: bold; background-color: #1f2937; border-radius: 10px; border: 1px solid black">Advanced Level</p><br> <p style="text-align: center; margin-right: 3%; font-weight: bold;">Required points to access this level:</p><div style="display: flex; margin-left: 38%;"><p id="advascr" style="font-weight: bold;"></p><p style="font-weight: bold;">&nbsp;points</p></div>
      </div>
        </div>

    <table class="table table-responsive-md">
    <tr>
      <td style="text-align: center;"> <x-button style="margin-right: 30px; background-color: #ffbf00; border-radius: 10px; border: 1px solid black;font-weight: bold;"><x-nav-link style="text-decoration: none !important; color: white; font-size: 30px;padding: 40px 40px 40px 40px; font-weight: bold;" :href="route('difficultyleveljava.javadquizbasic')" :active="request()->routeIs('difficultyleveljava.javadquizbasic')">{{ __('Start Quiz')}} </x-nav-link></x-button></td>
      <td style="text-align: center;"><a href="/javaquizinterdifficult"><x-button id="interbtn" disabled style="margin-right: -100px; text-decoration: none !important; color: white; font-size: 30px;padding: 50px 50px 50px 50px; background-color: #ffbf00; border-radius: 10px; border: 1px solid black; font-weight: bold;">{{ __('Start Quiz')}} </x-button></a></td>
      <td style="text-align: center;"><a href="/javaquizadvadifficult"><x-button id="advabtn" disabled style="margin-right: -565px; text-decoration: none !important; color: white; font-size: 30px;padding: 50px 50px 50px 50px; background-color: #ffbf00; border-radius: 10px; border: 1px solid black; font-weight: bold;">{{ __('Start Quiz')}} </x-button></a></td>
    </tr>
  </table>
  <br>
  <div class="flex-container">
    <div class="flex-child 4"><p style="margin-left: 28%;">Points obtained: </p><p style="margin-left: 17%;"><input id="basicscore" style="text-align:center; background:transparent; text-decoration: none !important;" value="{{$scorbas}}"disabled></p></div>
      <div class="flex-child 5"><p style="margin-left: 26%;">Points obtained: </p><p style="margin-left: 15%;"><input id="interscore" style="text-align:center; background:transparent; text-decoration: none !important;" value="{{$scorinter}}"disabled></p></div>
        <div class="flex-child 6"><p style="margin-left: 29%;">Points obtained: </p><p style="margin-left: 18%;"><input id="advscore" style="text-align:center; background:transparent; text-decoration: none !important;" value="{{$scoradva}}"disabled></p></div>
        </div>
      </div>
      <script>
