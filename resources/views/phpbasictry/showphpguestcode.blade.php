<x-app-layout x-data="{ open: false }">
  ...
  <x-nav-link :href="route('phpadvancetry.phpadvance')" :active="request()->routeIs('phpadvancetry.phpadvance')">
    ...
    <div class="card-body bg-white" style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; ">
      <pre style=" text-align: left; border: none!important; border-radius: 0%; color: black;">{{$phptabs->body}}</pre>
    </div>
...
<button style="border: solid;" id="run" onclick="run()">▶️ Run &nbsp;</button><br><br>

  <textarea id="input" style="width: calc(45% - 8px);" placeholder="Input Value here If Needed" ></textarea>
  <textarea readonly id="output" style=" margin-top: -50%; width: 37%; padding-bottom: 1.31%; background-color: black; color: white;" rows="16" placeholder="This will display the output of your code" ></textarea>
</div>
