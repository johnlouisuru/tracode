...
TRIVIA: This is the simple way of displaying your work in php
                  ...
                  <div class="popup" id="popup-1">
                    ...
                    <div style="margin-top:5%; margin-left:8%;"class="content">
                      ...
                      {!! Form::open(['action'=>['App\Http\Controllers\QuizScore\phpquiztry1update@update',$users->id],'method'=>'POST','class'=>'pull-right']) !!}
                            {{Form::hidden('phpscore','1000',['id'=>'1'])}}
                            {{Form::hidden('_method', 'PUT')}}
                              {{Form::submit('OK',['class'=>'btn-primary','style'=>'margin-top: 10px; width: 100px; border-radius: 10px;'])}}
                              {!! Form::close() !!}
                    </div>
                  </div>
                        </div>
