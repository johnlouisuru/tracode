  ...
  <div class="button" id="button1" title="points required 0">
    ...
    <div class="button" title="points required 1000">
      ...
      <div class="button" title="points required 3000">
        <x-nav-link class="navdes" :href="route('csharpquiztry4.csharpquiz4')" :active="request()->routeIs('csharpquiztry4.csharpquiz4')" >
        <button id="nbtn4" class="unstyled-button" disabled>
       {{ __('Level 4')}}</button></a></x-nav-link>
      </div>
              ...
              <div class="col-6 mx-auto">
                <div class="card text-center" style=" background-color: white; border: 1px solid black; margin-top:50px;">
                  <div class="card-header" style="background-color: rgb(238, 109, 109); color: black; border-bottom:1px solid black; margin-bottom: 20px;">
                      <p style="font-size: 30px; font-weight">C# Problem #4</p>
                  ...
                  TRIVIA: (Using math solution complete the code!!) -  math solutions are part of programming
                  </div>
                  <br>
                  <h3><b><i>
                  ...
                  <br>
                  <div><form id="formm" method="GET" action="/csharpquiztry4update/{{Auth::user()->id}}/edit">
                    @csrf
                  ...
                  <p style="margin-left:-65%;font-family: Courier New">{</p>
                  <p style="margin-left:-25%;font-family: Courier New">int Age = <input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" placeholder="Variable"  id="ans1" class="m-2 p-1">;</p>
                  <p style="margin-left:-17%;font-family: Courier New">int YrToday = <input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" placeholder="Variable"  id="ans2" class="m-2 p-1">;</p>
                  <p style="margin-left:8%;font-family: Courier New">int YrBorn = <input style="border:none; border-bottom:1px solid; background:transparent;width:100px;" type="text" name="value" placeholder="Data Type" id="ans3" class="m-2 p-1"> - <input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" name="trysagot" placeholder="Value" id="ans4" class="m-2 p-1">;</p>
                  <p style="font-family: Courier New">Console.WriteLine("Birthyear is:" + <input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" placeholder="Variable"  id="ans5" class="m-2 p-1">);</p>
      ...
      if(l >= 1000){
                      ...
                      function check(){
                        var a=Number(document.getElementById("ans1").value);
                          ...
                          var f = b - a;
                            if(a>=0 && b>=0 && c=="YrToday" && d=="Age" && e=="YrBorn" ){
...
<div class="popup" id="popup-1">
  ...
  <div style="margin-top:1%; margin-left:8%;"class="content">
    ...
    <div style="padding:10px; background-color: #1A1B1D;">
      <p style="font-family: Courier New; color: white;">Birthyear is: <input id="popanswer" style="background-color: transparent; border: none;" type="text" disabled value="{{ request('trysagot') }}"></p>
      
    </div>
    <input id="scorevalue" type="hidden" value="{{Auth::user()->csharpscore}}">
    {!! Form::open(['action'=>['App\Http\Controllers\QuizScore\csharpquiztry4update@update',$users->id],'method'=>'POST','class'=>'pull-right']) !!}
          {{Form::hidden('csharpscore','4000',['id'=>'1'])}}
          {{Form::hidden('_method', 'PUT')}}
            {{Form::submit('Proceed',['class'=>'btn-primary','style'=>'margin-top: 25px; width: 100px; border-radius: 10px;'])}}
            {!! Form::close() !!}
  </div>
</div>
<script>
