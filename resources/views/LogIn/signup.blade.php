        ...
        <div class=" container-fluid h-100">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="Fullname" placeholder="Enter Full Name" required>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="reenterpassword" placeholder="Re-enter Password" required>
                </div>
                
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="terms">
                    <label class="form-check-label" for="terms">I accept <a href="#"> terms and Agreement</a></label>
                  </div><br>
