  ...
  using System;
    ...
    <br>
      ...
      <button id="run" style="border: solid;" onclick="run()">▶️ Run &nbsp;</button><br><br>
        ...
        <textarea readonly id="output" style=" margin-top: -50%; width: 30%; padding-bottom: 3.9%; background-color: black; color: white;" rows="15" placeholder="This will display the output of your code" ></textarea>
      </div>
