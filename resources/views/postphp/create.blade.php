...
@section('contents')
 <h1>Create Post </h1>
 {!! Form::open(['action'=>'App\Http\Controllers\PhptabController@store','method'=>'POST','enctype'=>'multipart/form-data']) !!}
 <div class="container">
     <div class="card p-3">
    ...
    <div class="form-group">
        ...
        {{Form::textArea('codes','',['class'=>'form-control','placeholder'=>'Your code include']) }}
    </div>
    <div class="form-group">
        {{csrf_field() }}
    ...
    <a href="/phpdiff" class="back float-sm-right">	&#8641;</a>
        </div>
    </div>
{!! Form::close() !!}
