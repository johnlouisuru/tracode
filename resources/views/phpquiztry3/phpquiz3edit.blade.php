...
<div class="sidenav">
  ...
  <div class="button" id="button1">
    ...
    <div class="button"  title="points required 2000">
      <x-nav-link class="navdes" :href="route('phpquiztry3.phpquiz3')" :active="request()->routeIs('phpquiztry3.phpquiz3')" >
              ...
              <div class="col-6 mx-auto">
                <div class="card text-center" style=" background-color: white; border: 1px solid black; margin-top:50px;">
                  <div class="card-header" style="background-color: rgb(238, 109, 109); color: black; border-bottom:1px solid black; margin-bottom: 20px;">
                      <p style="font-size: 30px; font-weight">PHP Problem #3</p>
                          <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>&emsp;&emsp;<a href="https://onecompiler.com/php" style="text-decoration: none; color: black; " class=" h5" target="_blank">&#9998;</a>
                              ...
                              <div style=""><form id="formm" action="/phpquiztry3update/{{Auth::user()->id}}/edit">
                                  <p style="font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="value" placeholder="Symbol"  id="ans1" class="m-2 p-1">Line Comment symbol
                                      <p style=" font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="value" placeholder="Start"  id="ans3" class="m-2 p-1">Multiple Line symbol
                                    <p style="font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="value" placeholder="End"  id="ans2" class="m-2 p-1"> Ending Line Symbol    
                                    
                              <div style="margin-left: -55%"><p style="font-family: Courier New">?> </p></div>
                              <div style="" class="col"> 
                                <button id="btnans" type="submit" onclick="cond()">✔️ Proceed</button></form></div>
...
TRIVIA: This symbols are used for comments in your program
</div>
...
<div style="margin-top:5%; margin-left:8%;"class="content">
  ...
  <h3 style="margin-top: 5%;">Congratulations!</h3>
  <h2>    +1000 ⭐</h2>
  <input id="scorevalue" type="hidden" value="{{Auth::user()->phpscore}}">
  {!! Form::open(['action'=>['App\Http\Controllers\QuizScore\phpquiztry3update@update',$users->id],'method'=>'POST','class'=>'pull-right']) !!}
        {{Form::hidden('phpscore','3000',['id'=>'1'])}}
        {{Form::hidden('_method', 'PUT')}}
          {{Form::submit('Proceed',['class'=>'btn-primary','style'=>'margin-top:5%; width: 100px; border-radius: 10px;'])}}
          {!! Form::close() !!}
</div>
</div>
<script>
