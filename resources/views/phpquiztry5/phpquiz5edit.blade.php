...
<div class="sidenav">
  ...
  <div class="button" id="button1">
    <a href="{{ route('phpquiztry1.phpquiz1') }}" class="navdes">
    ...
    <div class="button" title="points required 4000">
      <x-nav-link class="navdes" :href="route('phpquiztry5.phpquiz5')" :active="request()->routeIs('phpquiztry5.phpquiz5')" >
      <button id="nbtn5" class="unstyled-button" disabled>
     {{ __('Level 5')}}</button></x-nav-link></div>
              ...
              <div class="col-6 mx-auto">
                <div class="card text-center" style=" background-color: white; border: 1px solid black; margin-top:50px;">
                  <div class="card-header" style="background-color: rgb(238, 109, 109); color: black; border-bottom:1px solid black; margin-bottom: 20px;">
                      <p style="font-size: 30px; font-weight">PHP Problem #5</p>
                          <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>&emsp;&emsp;<a href="https://onecompiler.com/php" style="text-decoration: none; color: black; " class=" h5" target="_blank">&#9998;</a>
                              ...
                              <div style=""><form id="formm" action="/phpquiztry5update/{{Auth::user()->id}}/edit">
                                <p style="font-family: Courier New">$age = <input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="C" placeholder="Number"  id="ans1" class="m-2 p-1">;</p>
                                <p style="font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:100px;" type="text" name="value" placeholder="Condition" id="ans2" class="m-2 p-1">( $age <input style="border:none; border-bottom:1px solid; background:transparent;width:70px;" type="text" name="trysagot" placeholder="Symbol" id="ans3" class="m-2 p-1"> 20 ){</p>
                                <p style="font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" name="C" placeholder="Function"  id="ans4" class="m-2 p-1">"Young Adult";}</p>
                              </div>
                              <div style="margin-left: -55%"><p style="font-family: Courier New">?></p></div>
                              <div style="" class="col"> 
                              <br>
                              <button id="btnans" type="submit" onclick="cond()" style="color:green; font-weight:100;">✔️ Proceed</button></form>
...
TRIVIA: The code must always meet the requirment of the condition
</div>
...
<div class="popup" id="popup-1">
  ...
  <div style="margin-top:5%; margin-left:8%;"class="content">
    ...
    <p style="background-color: transparent; color: white; margin-left: -75%;">Young Adult</p></div>
    <p id="scorevalue" type="hidden" value="{{Auth::user()->phpscore}}"></p>
    {!! Form::open(['action'=>['App\Http\Controllers\QuizScore\phpquiztry5update@update',$users->id],'method'=>'POST','class'=>'pull-right']) !!}
          {{Form::hidden('phpscore','5000',['id'=>'1'])}}
          {{Form::hidden('_method', 'PUT')}}
            {{Form::submit('Proceed',['class'=>'btn-primary','style'=>'width: 100px; border-radius: 10px;'])}}
            {!! Form::close() !!}
  </div>
</div>
<script>
