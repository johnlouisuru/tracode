...
<div class="sidenav">
    ...
    <div class="button">
        <form action="/cquiz5"><button class="unstyled-button " id="btn4" ><h3>Level 5</h3></form>
        </button>
    </div>
    <div class="button">
                    ...
                    <div class="card text-center" style=" background-color: #fedcda; border-radius: 20px; border: solid #fed4d2;">
                        <div class="card-header">
                            ...
                            <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>
                                ...
                                <div>
                                <div style="margin-top:-68%; margin-left: -14%;">
                              ...
                              <div style="margin-top:15%; margin-left: -60%;">
                                ...
                                <div style="margin-top:-44%; margin-left: 13%;">
                            ...
                            <div style="margin-top:16%; margin-left: -60%;">
                                <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:100px;" type="text" name="C" placeholder="Condition"  id="ans4" class="m-2 p-1"></p>
                            </div>
            ...
            <div class="popup" id="popup-1">
              ...
              <div class="popup" id="popup-2">
                ...
                <div style="margin-top:2%; margin-left:7.5%;"class="content">
                  ...
                  <p>Your Output is: </p>
                  <div style="padding:15px;display:flex;flex-wrap:wrap; background-color: black">
                  <b style="color: white; font-family:Consolas;" id="displayvalue3">Teenager</b>
                  </div>
                  <form action="/phpquiz5">
                    <button class="button" type="submit"> Proceed
                    </button>
