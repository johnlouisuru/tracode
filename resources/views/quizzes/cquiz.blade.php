...
<div class="sidenav">
    ...
    <div class="button">
        <form action="/cquiz"><button class="unstyled-button " id="btn1" disabled><h3>Level 2</h3></form>
        </button>
    </div>
    <div class="button">
                    ...
                    <div class="card text-center" style=" background-color: #fedcda; border-radius: 20px; border: solid #fed4d2;">
                        <div class="card-header">
                                                                    ...
                                                                    static void                 (string[] args)
                          {
                                ...
                                <div style="margin-top:-55%; margin-left: -30%;">
                                    <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" placeholder="Name"  id="ans1" class="m-2 p-1">; 
                                </div>
                                <div style="margin-top:16%; margin-left: -33%;">
                                    <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" placeholder="Name"  id="ans2" class="m-2 p-1">
                                </div>
                                <div style="margin-top:8%; margin-left: -23%;">
                                    <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:130px;" type="text" placeholder="Function"  id="ans3" class="m-2 p-1">
                                </div>
