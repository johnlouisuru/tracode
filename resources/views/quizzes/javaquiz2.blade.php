...
String a = "
                    ...
                    <input style=" border:none; border-bottom:1px solid; background:transparent;width:150px;" title="Needs to be string value" type="text" name="value" placeholder="Enter value Here"  id="value" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New"> "; </p>
                    </div>
                    <div class="row">
                <div class="col">
                    <div style ="margin-left:60px; margin-top:-5px;">
                <input style="border:none; border-bottom:1px solid; background:transparent;width:100px;" type="text" name="answer" placeholder="Enter answer Here"  id="ans" class="m-2 p-1"><p style="margin-left: -290px;margin-top:-40px; font-family: Courier New">System.out.print(                   
                </p>
