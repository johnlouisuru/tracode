    ...
    <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>
       ...
       public class Main {
               ...
               <div class="row">
                ...
                <input style="border:none; border-bottom:1px solid; background:transparent; width:170px;" type="text" name="answer" placeholder="Enter Answer Here"  id="ans" class="m-2 p-1">
                </p>
            </div>
            <div style="margin-left: 195px;">
                <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New"> ("<input style="border:none; border-bottom:1px solid; background:transparent;width:200px;" type="text" name="value" placeholder="Enter value Here"  id="value" class="m-2 p-1">");
            </div>
