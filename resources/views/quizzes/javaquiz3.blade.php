...
int sum;
                ...
                sum =                  +
                        ...
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:150px;"  title="Needs to be int value" type="text" placeholder="Number"  id="ans1" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New"> ; </p>
                        </div>
                        <div style="margin-left: -50px; margin-top:-5px">
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:150px;"  title="Needs to be int value" type="text" placeholder="Number"  id="ans2" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New"> ; </p>
                        </div>
                        <div style="margin-left: -155px; margin-top:30px">
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:125px;" title="Needs to be variable" type="text" placeholder="Variable"  id="ans3" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New">  </p>
                        </div>
                        <div style="margin-left: 180px; margin-top: -30px">
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:150px;" title="Needs to be variable" type="text"  placeholder="Variable"  id="ans4" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New">; </p>
                        </div>
                        <div style ="margin-left:60px; margin-top:-7px;">
                        <input style="border:none; border-bottom:1px solid; background:transparent;width:100px;" type="text"  placeholder="Variable"  id="ans5" class="m-2 p-1"><p style="margin-left: -280px;margin-top:-35px; font-family: Courier New">System.out.print(                   
                        </p>
