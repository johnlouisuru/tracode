...
<div class="sidenav">
    ...
    <div class="button">
        <form action="/cquiz4"><button class="unstyled-button " id="btn3" ><h3>Level 4</h3></form>
        </button>
 ...
 int Age = 
     ...
     int YrToday = 
                        ...
                        int YrBorn; =                  -
                                         ...
                                         Console.WriteLine("Year of Birth is" +                );
                        ...
                        <div style="margin-left: -50px; margin-top:-66%">
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:150px;"  title="Needs to be int value" type="text" placeholder="a"  id="ans1" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New"> ; </p>
                        </div>
                        <div style="margin-left: -10px; margin-top:-5px">
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:150px;"  title="Needs to be int value" type="text" placeholder="b"  id="ans2" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New"> ; </p>
                        </div>
                        <div style="margin-left: -2%; margin-top:-2%">
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:125px;" title="Needs to be variable" type="text" placeholder="c"  id="ans3" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New">  </p>
                        </div>
                        <div style="margin-left: 60%; margin-top: -30px">
                        <input style=" border:none; border-bottom:1px solid; background:transparent;width:150px;" title="Needs to be variable" type="text"  placeholder="d"  id="ans4" class="m-2 p-1"><p style="margin-top: -36px;margin-left: 170px; font-family: Courier New">; </p>
                        </div>
                        <div style ="margin-left:60%; margin-top:-7px;">
                        <input style="border:none; border-bottom:1px solid; background:transparent;width:100px;" type="text"  placeholder="e"  id="ans5" class="m-2 p-1"><p style="margin-left: -280px;margin-top:-35px; font-family: Courier New">                   
                        </p>
                        <p style="margin-left: 120px;margin-top:-40px; font-family: Courier New"></p>
                        </div>
                        <pre style="margin-top:10%;">
                            <p style="margin-left: -410px;margin-top:-80px; font-family: Courier New">     
    ...
    <script>
        function cond(){
                            ...
                            document.getElementById("displayvalue2").innerHTML = parseInt(b) - parseInt(a);
        }
        else{
            alert("Try again!");
        }
