                    ...
                    <div class="card text-center" style=" background-color: #fedcda; border-radius: 20px; border: solid #fed4d2;">
                        <div class="card-header">
                            ...
                            <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>
                                ...
                                <div>
                                <div style="margin-top:-56%; margin-left: -14%;">
                              ...
                              <div style="margin-top:12%; margin-left: -14%;">
                                <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New">= "<input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="C" placeholder="Number"  id="ans2" class="m-2 p-1">";</p>
                            </div>
                                </div>
                                <div style="margin-top:-35%; margin-right:-1%;"> <input style="border:none; border-bottom:1px solid; background:transparent;width:100px;" type="text" name="C" placeholder="Symbol"  id="ans3" class="m-2 p-1">
                                </div>
                                <div style="margin-top:15%;" class="col"> 
                                <br>
