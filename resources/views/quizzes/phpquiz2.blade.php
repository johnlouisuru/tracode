                        ...
                        <div class="card-header">
                            ...
                            <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>
                                ...
                                <div style="margin-top:-20%; margin-left: -45%;">
                                    <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="A" placeholder="Function"  id="ans1" class="m-2 p-1">
                                </div>
                                <div style="margin-top:0px; margin-left: 150px;">
                                    <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="B" placeholder="Variable"  id="ans2" class="m-2 p-1">;
                                </div>
                                <div>
                                <div style="margin-top:-24%; margin-left: -14%;">
                                  <p style="margin-left: 30px; margin-top:-68px; font-family: Courier New">= "<input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="C" placeholder="Value"  id="ans3" class="m-2 p-1">";
                              </div>
                                </div>
