...
<div class="sidenav">
  ...
  <div class="button" id="button1" title="points required 0">
    <x-nav-link class="navdes" :href="route('javaquiztry1.javaquiz1')" :active="request()->routeIs('javaquiztry1.javaquiz1')" >
              ...
              <div class="col-6 mx-auto">
                <div class="card text-center" style=" background-color: white; border: 1px solid black; margin-top:50px;">
                  <div class="card-header" style="background-color: rgb(238, 109, 109); color: black; border-bottom:1px solid black; margin-bottom: 20px;">
                      <p style="font-size: 30px; font-weight">Java Problem #1</p>
  ...
  <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>&emsp;&emsp;<a href="https://onecompiler.com/java" style="text-decoration: none; color: black; " class=" h5" target="_blank">&#9998;</a>
                  ...
                  <br>
                  <h3><b><i>
                      Complete the code that will display the value!
                  </i></b></h3>    
                  <form id="formm" method="GET" action="/javaquiztry1update/{{Auth::user()->id}}/edit">
                    @csrf
                  <div style="margin-left: -55%"><p style="font-family: Courier New">public class Main {</p></div>
                    <div style="margin-left: -15%"><p style="font-family: Courier New">public static void main(String[] args) {</p></div>
                                <div style=" ">
                                <p style="font-family: Courier New"><input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="value" placeholder="Function" id="ans" class="m-2 p-1">("<input style="border:none; border-bottom:1px solid; background:transparent;width:150px;" type="text" name="trysagot" placeholder="Enter value" id="value" class="m-2 p-1">");</p></div>
                                ...
                                <div class="popup" id="popup-1">
                                  ...
                                  <div style="margin-top:1%; margin0left: 8%;"class="content">
                                    ...
                                    {!! Form::open(['action'=>['App\Http\Controllers\QuizScore\javaquiztry1update@update',$users->id],'method'=>'POST','class'=>'pull-right']) !!}
                                          {{Form::hidden('javascore','1000',['id'=>'1'])}}
       ...
       e.preventDefault();
                      ...
                      function check(){
                          ...
                          var b=document.getElementById("value").value;
                            if(a=="System.out.println" && b!="" || a=="System.out.print" && b!=""){
