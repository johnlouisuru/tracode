...
<head>
    ...
    <body style="background-color: #90ebf0;">
        <div class="sidenav">
            <p> <a href="/phpintroguest" style="color: #ffbf00; text-decoration: none !important;"> PHP </p>
            ...
            <p> <a href="/javaintro" style="color: #ffbf00; text-decoration: none !important;">Java </p>
            ...
            <p><a href="/cintro" style="color: #ffbf00; text-decoration: none !important;"> C# </p>
        ...
        <div class="container">
          <div style="z-index: 100;margin-top: -10%;">
            <div class="card m-4" style="background-color: transparent; border: none!important;" >
                ...
                <center><h1>{{$phptabs->title}}</h1></center>
                </div>
                <div class="card-body bg-white" style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; ">
                    <pre style=" border: none!important; border-radius: 0%; color: black;">{{$phptabs->body}}</pre>
              </div>
              <div style="margin-top: 3%;">
                <center><img style="display: none" onload="this.style.display=''" src="/storage/{{$phptabs->filename}}" alt="" width="60%" height="mx-auto"/></center>
            </div>
          </div>
      </div>
  </div>
      </div>
      <div style="margin-left: 27.5%;margin-top:-9%">
        <h5>Try the codes here</h5>
        <textarea id="source" class="lined" spellcheck="false" style=" width: calc(45% - 8px);" rows="15" placeholder="Enter Syntax Code Here" >
        &lt;?php

        echo "Hello Tracoders";
    ...
    <br>
      ...
      <button id="run" onclick="run()">▶️ Run &nbsp;</button><br><br>
        ...
        <textarea id="input" style="width: calc(45% - 8px);" placeholder="Input Value here If Needed" ></textarea>
        <textarea readonly id="output" style=" margin-top: -50%; width: 37%; background-color: black; color: white;" rows="16" placeholder="This will display the output of your code" ></textarea>
      </div>
          <script type="text/javascript">
            API_KEY = "546f3a0b55msh3d518ef07a604b9p1f8bd1jsn28861b062c52";
