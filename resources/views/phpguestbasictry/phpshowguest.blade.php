...
<head>
    ...
    <br>
      ...
      <button id="run" onclick="run()">▶️ Run &nbsp;</button><br><br>
        ...
        <textarea readonly id="output" style=" margin-top: -50%; width: 35%; background-color: black; color: white;" rows="16" placeholder="This will display the output of your code" ></textarea>
      </div>
