<x-app-layout x-data="{ open: false }">
  ...
  <center><img style="display: none" onload="this.style.display=''" src="/storage/{{$javatabs->filename}}" alt="" width="60%" height="mx-auto"/></center>
      ...
      <div style="margin-left: 13%;margin-top:-8%">
        ...
        <textarea id="source" spellcheck="false" class="lined" style=" width: calc(53% - 8px);" rows="15" placeholder="Enter Syntax Code Here" >
  public class Main {
    public static void main(String[] args) {
      ...
      <button id="run" style="border: solid;"onclick="run()">▶️ Run &nbsp;</button><br><br>
        ...
        <textarea readonly id="output" style=" margin-top: -50%; width: 30%; background-color: black; color: white; padding-bottom:3.8%" rows="15" placeholder="This will display the output of your code" ></textarea>
      </div>
