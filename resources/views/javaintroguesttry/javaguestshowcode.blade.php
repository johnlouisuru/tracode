  ...
  public class Main {
    public static void main(String[] args) {
      ...
      <button id="run" style="border: solid;" onclick="run()">▶️ Run &nbsp;</button><br><br>
        ...
        <textarea readonly id="output" style=" margin-top: -50%; width: 30%; padding-bottom: 1.31%; background-color: black; color: white;padding-bottom:3.9%" rows="15" placeholder="This will display the output of your code" ></textarea>
      </div>
