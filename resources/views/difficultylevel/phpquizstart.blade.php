...
?>
    ...
    <br>
      ...
      <br><br>
        ...
        <textarea readonly id="output" style=" margin-top: -50%; width: 30%; background-color: black; color: white;position: relative; top: 0; padding-bottom: 2.6%;" rows="17" placeholder="This will display the output of your code" ></textarea>
      </div>
...
$(function() {
    ...
    <div class="popup" id="popup-1">
      ...
      <div style="margin-top:5%; margin-right:6%;"class="content">
        ...
        {!! Form::open(['action'=>['App\Http\Controllers\PhpScoringController@store'],'method'=>'POST','class'=>'pull-right']) !!}
