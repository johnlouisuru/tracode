...
<div class="sidenav">
  ...
  <div class="button" id="button1" title="points required 0">
    <x-nav-link class="navdes" :href="route('csharpquiztry1.csharpquiz1')" :active="request()->routeIs('csharpquiztry1.csharpquiz1')" >
              ...
              <div class="col-6 mx-auto">
                <div class="card text-center" style=" background-color: white; border: 1px solid black; margin-top:50px;">
                  <div class="card-header" style="background-color: rgb(238, 109, 109); color: black; border-bottom:1px solid black; margin-bottom: 20px;">
                      <p style="font-size: 30px; font-weight">C# Problem #1</p>
                          <a onclick="cond2()" href="#" style="text-decoration: none; color: black; " class=" h5">&#x1F4A1;</a>&emsp;&emsp;<a href="https://onecompiler.com/csharp" style="text-decoration: none; color: black; " class=" h5" target="_blank">&#9998;</a>
                              ...
                              <form id="formm" method="GET" action="/csharpquiztry1update/{{Auth::user()->id}}/edit">
                                @csrf
                              <p style="margin-left:-40%;font-family: Courier New">using<input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" placeholder="Name"  id="ans1" class="m-2 p-1">;</p>
                              <p style="margin-left:-33%;font-family: Courier New">namespace HelloWorld</p>
                              <p style="margin-left:-65%;font-family: Courier New">{</p>
                              <p style="margin-left:-40%;font-family: Courier New">class<input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" placeholder="Name"  id="ans2" class="m-2 p-1"></p>
                              <p style="margin-left:-65%;font-family: Courier New">{</p>
                              <p style="font-family: Courier New">static void<input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" placeholder="Function"  id="ans3" class="m-2 p-1">(string[] args)</p>
                              <p style="margin-left:-65%;font-family: Courier New">{</p>
                              ...
                              <div style="" class="col"> 
                                <br>
                                <br> <button id="btnans" type="submit" onclick="cond()"style="color:green; font-weight:100;">✔️ Proceed</button> </div></form> 
...
TRIVIA: Learning the syntax of a language can be a big heads up for you
</div>
  <div class="popup" id="popup-1">
    <div class="overlay"></div>
    <div style="margin-top:5%; margin-left:8%;"class="content">
      <div class="close-btn" onclick="myFunction()">×</div>
      <h3 style="margin-top: 10%;">Congratulations!</h3>
  <h2>    +1000 ⭐</h2>
      <input id="scorevalue" type="hidden" value="{{Auth::user()->csharpscore}}">
      {!! Form::open(['action'=>['App\Http\Controllers\QuizScore\csharpquiztry1update@update',$users->id],'method'=>'POST','class'=>'pull-right']) !!}
            {{Form::hidden('csharpscore','1000',['id'=>'1'])}}
            {{Form::hidden('_method', 'PUT')}}
              {{Form::submit('Proceed',['class'=>'btn-primary','style'=>'margin-top: 10%; width: 100px; border-radius: 10px;'])}}
              {!! Form::close() !!}
    </div>
  </div>
  <script>
