...
<div class="sidenav">
  ...
  <p style="font-family: Courier New">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;System.out.println(<input style="border:none; border-bottom:1px solid; background:transparent;width:90px;" type="text" name="C" placeholder="Variable"  id="ans3" class="m-2 p-1">);</p>
</div>
