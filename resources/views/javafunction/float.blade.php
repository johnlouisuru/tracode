...
<div style="margin-left: 200px;">
    <center><h1 style="margin-left: -70px;">Float Function</h1></center>
   
</div>
<center><h4 style="margin-top: 30px; "><p style="font-family: Trebuchet MS">   The Java float keyword is a primitive data type. It is a single-precision 32-bit IEEE 754 floating point.
  <br> It is used to declare the variables and methods. It represents the fractional numbers.</p></h4></center>
