...
class PhpScoringControllerinter extends Controller
{
    /**
    ...
    {
        return view ('difficultylevel.phpquizstartinsinter');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect("/insertquizinter?id=".$request->input('idquizz'));
