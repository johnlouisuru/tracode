...
class Quizzescsharpadva extends Controller
{
    public function show($id)
    {
       // $scorings=scoring::where('id',$id)->first();
        ...
        if(!$csharpquizs){
            ...
            return view('difficultylevelcsharp.csharpquizstartadva')->with('csharpquizs',$csharpquizs);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($csharpscoring){
            ...
            return redirect('/csharpquizadvadifficult');
