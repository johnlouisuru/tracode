...
class PhpScoringControlleradvance extends Controller
{
    /**
    ...
    {
        return view ('difficultylevel.phpquizstartinsadvance');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect("/insertquizadva?id=".$request->input('idquizz'));
