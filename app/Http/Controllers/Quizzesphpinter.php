...
class Quizzesphpinter extends Controller
{
    public function show($id)
    {
       // $scorings=scoring::where('id',$id)->first();
        ...
        if(!$phpquizs){
            ...
            return view('difficultylevel.phpquizstartinter')->with('phpquizs',$phpquizs);
        }

    public function edit($id)
    {
        $users=User::find($id);
        return view('difficultylevel.phpquizstart')->with('users',$users);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($scoring){
            ...
            return redirect('/phpquizinterdifficult');
